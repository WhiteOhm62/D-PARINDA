...
router.post("/login", async (req, res) => {
    ...
    try {
        ...
        console.log("error in catch during login time" + error.message);
    }
});
...
router.get("/getproductsone/:id", async (req, res) => {
    ...
    try {
        ...
        console.log(individual + "product by specific ID mila hai");
...
router.post("/addcart/:id", async (req, res) => {
    ...
    try {
        ...
        console.log(cart + "cart se product mila hain");
...
router.get("/remove/:id", async (req, res) => {
    try {
        ...
        console.log(error + "jwt authorization must be provided to remove any products from cart");
        res.status(400).json(error);
    }
});
